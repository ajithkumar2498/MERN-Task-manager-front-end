...
const ICONS = {
    ...
    message:(
        <BiSolidMessageRounded className='h-5 w-5 text-grau-600 group-hover:text-indigo-600'/>
    )
}
  ...
  return <>
   ...
   <Popover className="relative">
        <PopoverButton className='inline-flex items-center outline-none'>
            <div className="w-8 h-8 fex items-center justify-center text-gray-800 dark:text-white releative">

...
// useEffect(() => {
//   if (data) {
//     setSelectedUsers(team?.length > 0 ? team : [data[0]]);
//   }
// }, [data, team]);
      ...
      <div className="">
        ...
        >
          <div className="relative mt-1">
            <ListboxButton className="reletive w-full cursor-default rounded bg-white pl-3 pr-10 text-left px-3 py-2.5 2xl:py-3 border border-gray-300 dark:border-gray-600 sm:text-sm">
            ...
            <Transition
              as={Fragment}
              leave="translate ease-in duration-100"
              leaveFrom="opacity-100"
              leaveTo="opacity-0"
            >
              <ListboxOptions
                className="z-50 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base 
              ...
              >
                {data?.map((user, index) => (
                  <ListboxOption
                    ...
                    key={index}
                    className={({ active }) =>
                      `relative cursor-default select-none py-2 pl-10 pr-4.5 ${
